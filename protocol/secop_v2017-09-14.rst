...
For a list of properties see chapter "Descriptive Data".
...
See also _SECoP Issue 3_ (Timestamps)
...
-  **timeout** (optional value in seconds, a SEC node should be able to respond within
   a time well below this value. Default: 3 sec, see _SECoP issue 4_ )
...
-  **meaning**, **importance** (*see* _SECoP issue 9_)
